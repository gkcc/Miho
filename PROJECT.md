...
- **计划任务升级与重放**：用户授权后通过 owner-aware `Install` 事务把每日 09:30 任务从旧 `13F31369…` generation 切换到当前 release CLI `00B54E1328CA071F723B0D01E5927AD378DF21D7EAE91B1E4AAA35744D575E71`；candidate attempt `installer-9157b6f9854c42b09027c484b4e030a6` 完成双游戏更新并通过 exact health 后才提交，旧 generation 已退役。随后真实 canonical Task Scheduler action 再运行一次，attempt `20260718T120251843040Z-40188-0` 返回 0 且 exact health 为 healthy；任务为 Ready/Enabled、允许 demand start、触发器启用，下次仍为 2026-07-19 09:30，无 candidate 或 pending journal。重放后 Pyrois 仍为“佩洛伊斯”/`agent`/`release_order=2`、unresolved 为 0；HSR/ZZZ Box SHA-256 分别保持 `E0476FAA415CDD651DB69FD4B969E1C91FAB69C87DFEC86DE377183F009AC662` / `C677733006B569CBFB96EB95BF1827FB26A58292C1F17A9180AC7FF01E4D7491`。
