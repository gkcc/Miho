...
let DATA=null,state={page:PAGES.has(location.hash.slice(1))?location.hash.slice(1):'box',mode:'sd',role:'all',view:'trend',limit:'16',search:''},box={owned:new Set(),builds:{},buildSlug:'',element:'all',style:'all',status:'all',search:'',saveStatus:'浏览器缓存',exportStatus:''},rec={mode:'sd',scope:'',elements:{},gap:'1',riskMode:'warn',limit:'8',search:''},banner={phase:'current',search:''},boxSaveTimer=null,boxSaveRevision=0,boxSaveChain=Promise.resolve();
